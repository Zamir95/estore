...
const Checkout = () => {
  ...
  const handleCopyAddress = () => {
    setForm((prevState) => ({
      ...prevState,
      copyAddress: !prevState.copyAddress,
    }));
  };
    ...
    <form onSubmit={handleSubmit}>
      <CheckoutContainer>
        ...
        <CheckoutTable>
          ...
          <CheckoutAddress>
            <input type="text" name="billingAddress1" onChange={handleChange} />
            <input type="text" name="billingAddress2" onChange={handleChange} />
            <input type="text" name="billingCity" onChange={handleChange} />
          </CheckoutAddress>
          ...
          <CheckoutAddress>
            ...
            />
            <input type="text" name="shippingAddress2" onChange={handleChange} />
            <input type="text" name="shippingCity" onChange={handleChange} />
          </CheckoutAddress>
        </CheckoutTable>
